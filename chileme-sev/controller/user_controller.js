...
const testCode = async ctx => {
    // 1.验证手机号是否合法 不合法则直接提示手机号输入有问题 {code:200,msg:'手机号不合法',flag:1}
    // 2.去数据库中查找看该手机号是否被注册 若存在，提示用户改手机号已被注册 {code:200,msg:'该手机号已注册',flag:2}
...
const register = async ctx => {
    ...
    // 匹配则注册成功  {code:200,msg:'注册成功',flag:3}
    ctx.body = 'register'
}
/*
第一种
